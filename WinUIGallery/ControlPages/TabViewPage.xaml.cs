...
namespace AppUIBasics.ControlPages
{
    ...
    public sealed partial class TabViewPage : Page
    {
        ...
        {
            var page = new TabViewWindowingSamplePage();
            var window = WindowHelper.TrackWindow(new Window { Content = page, Title = "TabView windowing sample" });
            page.SetupWindow(window, true);
            window.Activate();
        }
    }
}
