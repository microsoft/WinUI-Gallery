...
/// <summary>
/// Telemetry levels. These levels are defined by our telemetry system, so it's possible the sampling
/// could change in the future. There aren't any convenient enums we can consume, so create our own.
/// </summary>
